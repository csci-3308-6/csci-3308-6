...
var showHands = function(showDealer)
{
    ...
    c = document.getElementById('pcard3');
    c.setAttribute("src", (appData.players[0].hand[2]).imgname);
    d = document.getElementById('dcard1');
    e = document.getElementById('dcard2');
    f = document.getElementById('dcard3');
    if(showDealer == true)
    {
        d.setAttribute("src", (appData.players[1].hand[0]).imgname);
        e.setAttribute("src", (appData.players[1].hand[1]).imgname);
        f.setAttribute("src", (appData.players[1].hand[2]).imgname);
    }
    else {
        d.setAttribute("src", "./cardback.PNG");
        e.setAttribute("src", "./cardback.PNG");
        f.setAttribute("src", "./cardback.PNG");
    }
